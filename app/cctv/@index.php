            ...
            <div class="responsive-data-table">
                <table id="responsive-data-table-summary" class="table dt-responsive nowrap hover" style="width:100%">
                    ...
                    <tbody>
                        ...
                        $get_total = $getdata->my_sql_select($connect, NULL, "problem_list", "se_id = '8' AND se_li_id = '154' AND  manager_approve_status = 'Y' AND (card_status NOT IN ('fe8ae3ced9e7e738d78589bf6610c4da','2e34609794290a770cb0349119d78d21') AND work_flag NOT IN  ('work_success','')) OR (manager_approve IS NULL AND se_id = '8' AND se_li_id = '154' AND card_status IN ('work_cctv')) ORDER BY CONVERT(ID, SIGNED) DESC,ID DESC,date ASC");
